@react.component
let make = (~page: Header.page, ~theme: Theme.theme=Theme.Dark) => {
  ...
  // -- VIEW
  <Scrollview id="Home" bottom="3rem" opacity pointerEvents tabIndex theme top="2.5em" transform>
    <p style={ReactDOM.Style.make(
    ~margin="1rem 0 0.5rem 0", (),)}> {"Hey, I'm Darren"->React.string} </p>
    <img
      alt="Picture-of-Darren"
      src="./images/darren.jpeg"
      style={ReactDOM.Style.make(~border="solid #000", ~borderWidth="2px 8px", ~boxSizing="border-box", ~width="100%", ())}
    />
    <p>
